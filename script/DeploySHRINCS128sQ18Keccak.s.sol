...
contract DeploySHRINCS128sQ18Keccak is CreateXDeployer {
    ...
    bytes32 internal constant SALT = bytes32(
        abi.encodePacked(
            bytes20(DEPLOYER),
            SALT_FLAG,
            bytes11(keccak256("QUIP:SHRINCS128sQ18Keccak:V4.0"))
        )
    );
    ...
    // DeploySPHINCSPlusC128sQ18Keccak.RUNTIME_CODEHASH: internal
    // constants are not cross-contract accessible, so _requireSibling
    // takes it as an argument; SHRINCSPinned128sQ18.t.sol asserts the
    // two stay equal.
    ...
    bytes32 internal constant RUNTIME_CODEHASH =
        0xc07f64ea03d16d6e24f7c8a3511dc6fd98aa7f7c5af7d11eb4f74284927685ca;
