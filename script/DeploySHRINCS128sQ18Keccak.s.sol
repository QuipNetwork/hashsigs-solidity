...
contract DeploySHRINCS128sQ18Keccak is CreateXDeployer {
    ...
    bytes32 internal constant SALT = bytes32(
        abi.encodePacked(
            bytes20(DEPLOYER),
            SALT_FLAG,
            bytes11(keccak256("QUIP:SHRINCS128sQ18Keccak:V2.0"))
        )
    );
    ...
    bytes32 internal constant SPHINCS_PLUS_C_SALT = bytes32(
        abi.encodePacked(
            bytes20(DEPLOYER),
            SALT_FLAG,
            bytes11(keccak256("QUIP:SPHINCSPlusC128sQ18Keccak:V2.0"))
        )
    );
    ...
    bytes32 internal constant RUNTIME_CODEHASH =
        0xdfaf792792620176cf24518a87839339022508faccde515ef2345d46ef574ee5;
