...
contract ShrincsPorsFpNoMaskVerifier is ShrincsStatelessPorsFp, ShrincsStatelessHypertree {
    function verify(
        ...
        ParamsView memory p = variantParamsView(params, MODE_PORS_FP, false);
