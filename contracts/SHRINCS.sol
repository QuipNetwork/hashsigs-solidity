...
library SHRINCS {
    ...
    function verifyStateless(
        ...
        ShrincsType.ParamsView memory p = _paramsView(params);
        ...
        returns (bool)
    {
        ...
        if (params.parameterSetId != publicKey.parameterSetId || params.hashSuiteId != publicKey.hashSuiteId) return false;
