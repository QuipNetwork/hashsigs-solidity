...
contract ShrincsForsCMaskVerifier is ShrincsStatelessForsC, ShrincsStatelessHypertree {
    function verify(
        ...
        ParamsView memory p = variantParamsView(params, MODE_FORS_C, true); // true for mask
