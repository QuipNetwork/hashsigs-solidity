...
import {
    DeploySHRINCS128sQ18Keccak
} from "../script/DeploySHRINCS128sQ18Keccak.s.sol";
import {
    DeploySPHINCSPlusC128sQ18Keccak
} from "../script/DeploySPHINCSPlusC128sQ18Keccak.s.sol";
...
contract DeploySHRINCS128sQ18Probe is DeploySHRINCS128sQ18Keccak {
...
contract SHRINCSPinned128sQ18Test is Test {
    ...
    bytes32 internal constant CHILD_LABEL =
        keccak256("QUIP:SPHINCSPlusC128sQ18Keccak:V2.0");
    ...
    function testPinnedAddressMatchesCreate3Derivation() public {
        ...
        DeploySHRINCS128sQ18Probe probe = new DeploySHRINCS128sQ18Probe();
        assertEq(
            probe.siblingSalt(),
            childSalt,
        ...
        DeploySPHINCSPlusC128sQ18Probe childProbe =
            new DeploySPHINCSPlusC128sQ18Probe();
        assertEq(
            childProbe.salt(),
            childSalt,
